...
module.exports = {
    data: new SlashCommandBuilder()
        ...
        .setName("247")
        .setDescription("24/7")
        .addChoices({ name: "yes", value: "false" }, { name: "no", value: "true" })),
    execute(interaction) {
        var _a, _b;
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const result = yield interaction.client.player.search(check, {
                ...
                yield interaction.editReply({ content: `Loading a: ${result.playlist ? 'playlist' : 'track'}` });
                const yes = yield interaction.client.player.play((_a = interaction.member.voice.channel) === null || _a === void 0 ? void 0 : _a.id, result, {
                    nodeOptions: {
                        metadata: {
                            channel: interaction.channel,
                            client: (_b = interaction.guild) === null || _b === void 0 ? void 0 : _b.members.me,
